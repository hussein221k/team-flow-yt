...
import Arjetlogo from "@/public/arcjetlogo.png";
import Prismalogo from "@/public/prisma-logo.svg";
import Vercellogo from "@/public/vercel-logo.svg";
import Orpc from "@/public/orpc-img.webp";
import Kindelogo from "@/public/kinde-logo.png";
import Motionlogo from "@/public/motion.png";
import Neonlogo from "@/public/neon-img.png";
      ...
      <main className="overflow-hidden">
        ...
        <section>
          <div className="relative pt-24 md:pt-36">
            ...
            >
              <img
                src="https://gist.github.com/user-attachments/assets/db23540b-f4bb-456e-b5ef-74aa9cf6be30"
                alt="background"
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  The AI-ready home for team communications
                </TextEffect>
                <TextEffect
                  per="line"
                  preset="fade-in-blur"
                ...
                >
                 Tailflow organizes converstions into channels with threads , is realtime , and uses AI to teams in sync.
                </TextEffect>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Link href="#link">
                        <span className="text-nowrap">Get Starting</span>
                      </Link>
                    </Button>
                  </div>
                  <Button
